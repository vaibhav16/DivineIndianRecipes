...
namespace DivineIndianRecipes.dessertpages
{
    public partial class gulab : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipe/13202/gulab-jamun-with-home-made-khova-khoya-mawa.aspx?o_is=SR";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/gulab.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
        ...
        private void ShareApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            shareLinkTask.Title = "Divine Indian Recipes";
            shareLinkTask.LinkUri = Browser.Source;
            shareLinkTask.Message = "Amazing Snooker app for your Windows Phone!";
