...
{
    public partial class gajar : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipe/301/sweet-gajar-ka-halwa.aspx?o_is=SR";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/gajar.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
