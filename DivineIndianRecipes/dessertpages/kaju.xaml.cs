...
{
    public partial class kaju : PhoneApplicationPage
    {
         private string _homeURL = "http://allrecipes.co.in/recipe/20/punjabi-kaju-katli.aspx?o_is=SR";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/kaju.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
