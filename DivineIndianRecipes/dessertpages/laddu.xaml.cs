...
{
    public partial class laddu : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipe/12209/beshon-er-laddoo--besan-laddoo-.aspx?o_is=SR";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/laddu.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
