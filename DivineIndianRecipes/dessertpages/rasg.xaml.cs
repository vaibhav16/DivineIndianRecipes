...
{
    public partial class rasg : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipe/139/rasgulla.aspx?o_is=SR";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/rasg.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
