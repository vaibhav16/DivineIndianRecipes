...
{
    public partial class kofta : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipe/12101/yasmin-s-chitol-mach-kofta---chitol-fish-kofta-.aspx?o_is=Hub_TopRecipe_2";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/kofta.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
