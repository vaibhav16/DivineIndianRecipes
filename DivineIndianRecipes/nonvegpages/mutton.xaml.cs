...
{
    public partial class mutton : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/tag-14/mutton-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/mutton.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
