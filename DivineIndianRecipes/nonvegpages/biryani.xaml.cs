...
{
    public partial class biryani : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/biryani-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/biryani.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
