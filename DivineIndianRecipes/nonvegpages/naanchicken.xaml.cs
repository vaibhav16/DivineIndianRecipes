...
{
    public partial class naanchicken : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipe/1806/naan-chicken-sandwich.aspx?o_is=LV";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/naanchicken.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
