...
namespace DivineIndianRecipes.nonvegpages
{
    ...
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/chicken-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/chicken.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
