...
{
    public partial class fish : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/fish-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/fish.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
