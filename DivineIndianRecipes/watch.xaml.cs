...
namespace DivineIndianRecipes
{
    public partial class watch : PhoneApplicationPage
    {
        ...
        private string _homeURL = "http://www.youtube.com/results?search_sort=video_avg_rating&search_query=indian+recipes";
        ...
        public watch()
        {
            ...
            BackKeyPress += gord_BackKeyPress;
        ...
        void gord_BackKeyPress(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        private void ShareApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            shareLinkTask.Title = "Snooker Master";
