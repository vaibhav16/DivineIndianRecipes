...
{
    public partial class aloo : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/aloo-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/aloo.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
