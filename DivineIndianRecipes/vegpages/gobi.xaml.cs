...
{
    public partial class gobi : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/tag-461/cabbage-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/gobi.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
