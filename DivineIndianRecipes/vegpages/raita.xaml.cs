...
namespace DivineIndianRecipes.subpages
{
    public partial class raita : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/tag-454/raita-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/raita.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
