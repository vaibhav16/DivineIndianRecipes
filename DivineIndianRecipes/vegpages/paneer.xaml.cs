...
{
    public partial class paneer : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/paneer-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/paneer.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
