...
{
    public partial class palak : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/palak-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/palak.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
