...
{
    public partial class dal : PhoneApplicationPage
    {
        private string _homeURL = "http://allrecipes.co.in/recipes/dal-recipes.aspx";
        ...
        private void PinApplicationBar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ShellTile.Create(new Uri("/dal.xaml?StartURL=" + Browser.Source.ToString(), UriKind.Relative), tileData, false);
            }
            catch (Exception ex)
            {
